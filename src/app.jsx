    ...
    <nav className="nav">
      <div className="container nav-row">
        ...
        <div className="nav-links">
          ...
          <a href="https://predictableai.vanarsi.com" target="_blank" rel="noopener">{t.nav.product}</a>
    ...
    <section className="hero">
      ...
      <div className="container">
        ...
        <div className="hero-actions">
          ...
          <a href="https://predictableai.vanarsi.com" target="_blank" rel="noopener" className="btn btn-ghost">{t.hero.cta_secondary}</a>
        </div>
